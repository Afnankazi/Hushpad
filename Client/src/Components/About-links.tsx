...
export default function MouseTrailDemo() {
  return (
          ...
          <section className="flex flex-col md:flex-row lg:flex-row mt-7 gap-7 text-black">
            <div className="group flex items-center justify-center ">
              <Icons.linkedin />
              <FlipLink href="https://www.linkedin.com/in/afnan-kazi-13100a28b/">Linkedin</FlipLink>
            </div>
            <div className="group flex items-center justify-center">
              <Icons.github fill="red" />
              <FlipLink href="https://github.com/Afnankazi">Github</FlipLink>
            </div>
          </section>
  )
}
